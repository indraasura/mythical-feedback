"""
Django 1.11.6 (strict)
1.11.3 was giving some error with channels
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '139.59.37.82', 'db05c913.ngrok.io']
...
WEBSITE_URL = 'https://db05c913.ngrok.io/autocall'
